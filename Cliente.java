...
public class Cliente {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DataOutputStream mensaje = new DataOutputStream(cliente.getOutputStream());//DataOutputStream- envia informacion al socket del servidor
			mensaje.writeUTF("Hola servidor");
			/*** LEEMOS ***/				
			//Aqui el cliente lee el menu de operaciones
			DataInputStream entrada = new DataInputStream(cliente.getInputStream());//DataInputStream- recibe las respuestas que el servidor envia
